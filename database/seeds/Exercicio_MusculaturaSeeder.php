...
class Exercicio_MusculaturaSeeder extends Seeder
{
    ...
    {   
        ...
        //Supino e Peitoral
        DB::table('exercicio_musculatura')->insert(['exercicio_id' => '1', 'musculatura_id' => '6']);
        ...
        DB::table('exercicio_musculatura')->insert(['exercicio_id' => '3', 'musculatura_id' => '8']);
        //Leg Press e Abdômen
        DB::table('exercicio_musculatura')->insert(['exercicio_id' => '3', 'musculatura_id' => '9']);
    }
}
