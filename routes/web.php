...
Route::group(['middleware' => 'auth', 'namespace' => 'Praticante'], function(){
    ...
    Route::get('praticante/treino/',          'PraticanteController@visualizarTreino')->name('praticanteVisualizarTreino');
    Route::post('praticante/treino/',         'PraticanteController@praticanteSalvarTreino')->name('praticanteSalvarTreino');
});
...
Route::group(['middleware' => 'auth', 'namespace' => 'Admin'], function(){
    ...
    Route::get('admin/anamnese/getLesoesList',   'AnamneseController@getLesoesList');
    /*Rotas Exame*/
    ...
    Route::get('admin/avaliacao/               ', 'AvaliacaoController@view')->name('visualizarAvaliacao'); 
    Route::get('admin/avaliacao/searchAvaliacao', 'AvaliacaoController@searchAvaliacao');
    /*Rota Limpeza*/
